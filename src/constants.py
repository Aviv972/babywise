...
class QuestionFields:
    ...
    BATHING_SCHEDULE = 'bathing_schedule'
...
class ResponseTypes:
    ...
    QUERY = 'query'  # For when we need to ask follow-up questions
    REFERRAL = 'referral'  # For when we need to refer to another agent
...
class AgentTypes(str, Enum):
    ...
    TRAVEL = 'travel'
    PREGNANCY = 'pregnancy'
    MENTAL_HEALTH = 'mental_health'  # Added mental health agent type
...
class RequiredFields:
    BY_AGENT = {
        ...
        AgentTypes.PREGNANCY: [
            QuestionFields.PREGNANCY_WEEK,
            QuestionFields.SYMPTOMS,
            QuestionFields.MEDICAL_HISTORY,
            QuestionFields.CONCERNS
        ]
    }
    ...
    QUESTIONS = {
        ...
        # Travel questions
        QuestionFields.TRAVEL_TYPE: "What type of travel are you planning (flight, car, etc.)?",
        QuestionFields.DESTINATION: "Where are you planning to travel?",
        QuestionFields.DURATION: "How long will the trip be?",
        
        # Pregnancy questions
        QuestionFields.PREGNANCY_WEEK: "How many weeks pregnant are you?",
        QuestionFields.MEDICAL_HISTORY: "Do you have any relevant medical history to share?",
        
        # Product questions
        QuestionFields.BUDGET: "What is your budget range?",
        QuestionFields.FEATURES: "What specific features are you looking for?",
        QuestionFields.USAGE: "How do you plan to use this item?",
        
        # Hygiene questions
        QuestionFields.CURRENT_ROUTINE: "What is your current hygiene/care routine?",
        QuestionFields.SKIN_CONDITION: "How is your baby's skin condition?",
        QuestionFields.PRODUCTS_USED: "What products are you currently using?"
    }
